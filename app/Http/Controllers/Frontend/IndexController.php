...
class IndexController extends Controller
{
    public function Index(){
        ...
        return view('frontend.index',compact('newnewspost','newspopular','skip_cat_0','skip_news_0','skip_cat_2','skip_cat_1','skip_news_1','skip_cat_4'));
    } // End Method
    ...
    public function Lokasi(){
        ...
        return view('frontend.news.lokasi',compact('newnewspost','newspopular'));

    }// End Method

    public function Batik(){

        return view('frontend.news.batik');

    }// End Method

    public function IndexBatik(){

        return view('frontend.news.indexbatik');

    }// End Method

    public function AboutBatik(){

        return view('frontend.news.aboutbatik');

    }// End Method

    public function Workshop(){

        return view('frontend.news.workshop');
    ...
    public function Struktur(){
        ...
        return view('frontend.news.struktur',compact('newnewspost','newspopular'));
    ...
    public function Visi(){
        ...
        return view('frontend.news.visi',compact('newnewspost','newspopular'));
    ...
    public function JumlahPenduduk(){
        ...
        return view('frontend.news.jumlahpenduduk',compact('newnewspost','newspopular'));
    ...
    public function KantorDesa(){
        ...
        return view('frontend.news.kantordesa',compact('newnewspost','newspopular'));

    }// End Method

    public function TokohMasyarakat(){

        $newnewspost = NewsPost::orderBy('id','DESC')->limit(8)->get();
        $newspopular = NewsPost::orderBy('view_count','DESC')->limit(8)->get();

        return view('frontend.news.tokohmasyarakat',compact('newnewspost','newspopular'));
    ...
    public function Galeri(){
        ...
        return view('frontend.news.galeri',compact('newnewspost','newspopular'));
    ...
    public function VideoGaleri(){
        ...
        return view('frontend.news.videogaleri',compact('newnewspost','newspopular'));
