                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.photo.struktur') }}" enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" name="id" value="{{ $photostruktur->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8 mb-3">
                                        ...
                                        <img src="{{ asset($photostruktur->photo_struktur) }}" style="width: 400px; height: 200px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" name="jabatan" class="form-control" id="inputEmail4"
                                            placeholder="Add Jabatan" value="{{ $photostruktur->jabatan }}">
                                    </div>
