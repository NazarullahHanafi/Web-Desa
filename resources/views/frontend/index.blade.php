...
@include('frontend.body.newss')
@include('frontend.body.list')

<section class="themesBazar_section_one mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="themesBazar_widget">
                    <h3 style="margin-top:5px"> Kalendar </h3>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-md-4">
                                <div class="header">
            ...
            <div class="themesBazar_widget">
                <h3 style="margin-top:5px"> Peta Desa </h3>
...
<section class="section-seven">
    <div class="container">
        ...
        <h2 class="themesBazar_cat01"> <a href=" "> {{ $skip_cat_0->category_name }} </a> <span> <a
                    href="{{ url('news/category/' . $skip_cat_0->id . '/' . $skip_cat_0->category_slug) }}"> More <i
                        class="las la-arrow-circle-right"></i> </a></span> </h2>
    ...
    for (let i = 0; i < 6; i++) {
        ...
        for (let j = 0; j < 7; j++) {
            if (i === 0 && j < firstDayOfMonth) {
                ...
                const classToday = dayCount === today ? "today" : "";
                calendarHtml += `<td class="${classToday}">${dayCount}</td>`;
                dayCount++;
            } else {
                calendarHtml += "<td></td>";
            }
