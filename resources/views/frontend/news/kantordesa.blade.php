            ...
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href="{{ url('/') }}"><i class="las la-home"></i>Home</a> <i
                        class="las la-chevron-right">Surat Pengurusan Desa</i>
                        <br><br>
                    <div class="col-lg-12 col-md-12">
                            <img src="{{ asset('halamandesa.jpg') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-12 col-md-12 mt-5">
                            <img src="{{ asset('suratpengurusan.jpg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row">
