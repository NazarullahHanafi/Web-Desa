            ...
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href="{{ url('/') }}"><i class="las la-home"></i>Home</a> <i
                        class="las la-chevron-right">Struktur Desa</i>
                    <div class="col-lg-12 col-md-12">
                            <img src="{{ asset('peta.jpg') }}" class="img-fluid" alt="">
                    </div>
                                    ...
                                    <div class="homeGallery owl-carousel owl-loaded owl-drag">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                ...
                                                @php
                                                    $photo_struktur1 = App\Models\PhotoStruktur::latest()->get();
                                                @endphp

                                                @foreach ($photo_struktur1 as $item)
                                                    <div class="owl-item" style="width: 784px; margin-right: 10px;">
                                                        <div class="item">
                                                            <div class="photo">
                                                                <a class="themeGallery" href="{{ asset($item->photo_struktur) }}">
                                                                    <img src="{{ asset($item->photo_struktur) }}" alt="PHOTO"></a>
                                                                <h3 class="photoCaptionn text-white">
                                                                    <a href=" ">{{ $item->jabatan }} </a> <br>
                                    ...
                                    <div class="homeGallery1 owl-carousel owl-loaded owl-drag">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                ...
                                                @php
                                                    $photo_struktur2 = App\Models\PhotoStruktur::latest()->get();
                                                @endphp

                                                @foreach ($photo_struktur2 as $item)
