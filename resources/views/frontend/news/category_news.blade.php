...
@section('home')
@section('title')
{{ $breadcat->category_name }} | Lalang Kabung
@endsection
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="rachive-info-cats">
                    <a href="{{ url('/') }}"><i class="las la-home">Home</i> </a> <i class="las la-chevron-right"></i>
                ...
                {{-- <div class="row">
                    <div class="col-md-12">
                        <a class="next page-numbers text-black" href=" ">Next »</a>
                    </div>
                </div> --}}
