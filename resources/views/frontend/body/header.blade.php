                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="{{ url('/') }}" title="NewsFlash">
                                <img style="height: 100px;" src="{{ asset('frontend/assets/images/logo_desa.jpg') }}"
                                    alt="NewsFlash" title="NewsFlash">
                            </a>
                        </div>
                    </div>
                    ...
                    <ul id="menu-main-menu" class="menu">
                        ...
                        <li id="menu-item-277"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-277"><a
                                href="{{ route('lokasi') }}">Profil Desa</a>
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-294"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294"><a
                                        href="{{ route('jumlahpenduduk') }}">
                                        Jumlah Penduduk
                                    </a></li>
                                    <li id="menu-item-294"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294"><a
                                        href="{{ route('kantordesa') }}">
                                        Kantor Desa
                                    </a></li>
                                    <li id="menu-item-294"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294"><a
                                        href="{{ route('tokohmasyarakat') }}">
                                        Tokoh Masyarakat
                                    </a></li>
                            </ul>
                        </li>
                        <li id="menu-item-277"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-277"><a
                                href="{{ route('lokasi') }}">Kearifan Lokal</a>
                            <ul class="sub-menu">

                                <li id="menu-item-294"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294"><a
                                        href="{{ route('indexbatik') }}">
                                        Batik
                                    </a></li>
